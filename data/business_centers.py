...
class Business_center(SqlAlchemyBase, SerializerMixin):
    ...
    total_area = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    klass = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    floors = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    ...
    photo = sqlalchemy.Column(sqlalchemy.String, nullable=True, default="")
